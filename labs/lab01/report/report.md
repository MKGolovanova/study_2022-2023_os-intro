...
Программы для удобства работы в консоли: (рис. [-@fig:024]).

![ ](image/Снимок экрана от 2023-02-18 23-38-13.png ){#fig:024 width=70%}
...
Я демонтировала диск:(рис. [-@fig:025]).

![Извлечение образа диска ](image/Снимок экрана от 2023-02-18 22-37-02.png){#fig:025 width=70%}
